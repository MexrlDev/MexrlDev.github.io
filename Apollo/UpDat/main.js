(function () {
  ...
  var jar_labels = ['UpDat', 'Start JB', 'HDD Payloads', 'Online DB', 'Tools', 'Settings', 'About'];
  ...
  // ==================== LOAD JARS ====================
  var jarNames = ['jar_UpDat', 'jar_JB', 'jar_hdd', 'jar_empty', 'jar_empty', 'jar_opt', 'jar_about'];
  ...
  function handleJarAction(index) {
    ...
    switch (index) {
      case 0: // UpDat script in themes/apollo
        log('Loading themes/apollo/UpDat.js');
        include('themes/apollo/UpDat.js');
        break;
